...
@Component({
  selector: 'app-detalles-operaciones-tarjetas-prop',
  templateUrl: './detalles-operaciones-tarjetas-prop.component.html',
  styleUrls: ['./detalles-operaciones-tarjetas-prop.component.css']
})
export class DetallesOperacionesTarjetasPropComponent implements OnInit {
