...
export interface IAdditionalEnviromentRequest {
	...
	bandVip: string;
	/** Bandera para indicar si se almacena o se actualiza la opcion de Cliente VIP bandCV */
	bandCV: boolean;
    /** Bandera para indicar si se almacena o se actualiza la opcion de Cliente VIP bandCVAnt */
	bandCVAnt: string;
